...
if [ "$1" == "meditron-13b-summarizer"  ] || [  "$1" == "all" ]; then
    python3 utils/infer.py \
        ...
        --model_path /pure-mlo-scratch/make_project/trial-runs/pubmed-13b-summarizer/hf_checkpoint/ \
        --input_path $INPUT_PATH \
...
if [ "$1" == "meditron-13b-generator"  ] || [  "$1" == "all" ]; then
    python3 utils/infer.py \
        ...
        --model_path /pure-mlo-scratch/make_project/trial-runs/pubmed-13b-generator/hf_checkpoint/ \
        --input_path $INPUT_PATH \
...
if [ "$1" == "meditron-13b-direct"  ] || [  "$1" == "all" ]; then
    python3 utils/infer.py \
        ...
        --model_path /pure-mlo-scratch/make_project/trial-runs/pubmed-13b-direct-trunc/hf_checkpoint/ \
        --input_path $INPUT_PATH \
